            ...
            <div class="bg-white dark:bg-gray-800 shadow-sm sm:rounded-lg" x-data="consumableManager()">
                ...
                <div
                    ...
                    <div class="flex gap-2 items-center">
                        ...
                        <!-- Sync Button -->
                        <form method="POST" action="{{ route('admin.consumables.sync') }}">
                            @csrf
                            <button type="submit"
                ...
                <form id="bulkDeleteForm" method="POST" action="{{ route('admin.consumables.bulk-delete') }}"
                    class="hidden">
                    @csrf
        ...
        function consumableManager() {
            return {
                ...
                confirmDelete(id, name) {
                    ...
                    this.deleteUrl = '{{ url("admin/consumables") }}/' + id;
