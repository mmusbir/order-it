    ...
    <div class="py-8">
        <div class="max-w-2xl mx-auto sm:px-6 lg:px-8">
            ...
            <div class="bg-white dark:bg-gray-800 rounded-xl shadow-sm border border-gray-100 dark:border-gray-700 p-6">
                <h2 class="text-2xl font-bold text-gray-900 dark:text-white mb-6">Create Job Title</h2>

                <form method="POST" action="{{ route('superadmin.settings.job-titles.store') }}" class="space-y-6">
                    @csrf
                    ...
                    <div>
                        ...
                        <input type="text" name="name" value="{{ old('name') }}" required
                            placeholder="e.g. Manager IT, Staff Finance"
                    ...
                    <div>
                        ...
                        <textarea name="description" rows="3" placeholder="Deskripsi job title ini..."
