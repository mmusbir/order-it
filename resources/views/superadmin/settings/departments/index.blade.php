        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            ...
            <div class="flex flex-col md:flex-row justify-between items-start md:items-center mb-8 gap-4">
                <div>
                    ...
                    <p class="text-gray-500">Manage departments and assign users to departments.</p>
                </div>
                <a href="{{ route('superadmin.settings.departments.create') }}"
            ...
            <div class="max-w-2xl">
                ...
                <div
                    ...
                    <div class="px-6 py-4 border-b border-gray-100 dark:border-gray-700">
                        ...
                        <p class="text-sm text-gray-500 dark:text-gray-400">{{ $departments->count() }} departments
                        </p>
                    </div>
                            ...
                            <div class="p-4 hover:bg-gray-50 dark:hover:bg-gray-700/50 transition">
                                <div class="flex items-center justify-between">
                                    <div>
                                        ...
                                        @if($dept->code)
                                            <p class="text-xs text-gray-500 dark:text-gray-400">Code: {{ $dept->code }}</p>
                                        @endif
                                        <div class="flex items-center gap-2 mt-1">
                                            <span class="text-xs text-gray-400 dark:text-gray-500">{{ $dept->users_count }}
                                                users</span>
                                            @php
                                                $approvalCount = $dept->approvalLevels->where('is_active', true)->count();
                                            @endphp
                                            @if($approvalCount > 0)
                                                <span
                                    ...
                                    <div class="flex items-center gap-2">
                                        <a href="{{ route('superadmin.settings.departments.edit', $dept) }}"
                                        ...
                                        <form method="POST"
                                            action="{{ route('superadmin.settings.departments.destroy', $dept) }}"
                                            onsubmit="return confirm('Delete this department? Users will be unassigned.')">
                                            @csrf
                                            @method('DELETE')
