        ...
        <div class="max-w-2xl mx-auto sm:px-6 lg:px-8">
            ...
            <div class="bg-white dark:bg-gray-800 rounded-xl shadow-sm border border-gray-100 dark:border-gray-700 p-6">
                ...
                <form method="POST" action="{{ route('admin.users.update', $user) }}" class="space-y-5">
                    ...
                    <div>
                        <label class="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-1">Email Address
                    ...
                    <div>
                        ...
                        <input type="text" name="employee_number"
                            value="{{ old('employee_number', $user->employee_number) }}" required
                            placeholder="e.g. EMP001"
                            class="w-full px-4 py-2 border border-gray-200 dark:border-gray-600 dark:bg-gray-700 dark:text-white rounded-lg focus:ring-indigo-500 focus:border-indigo-500">
                    </div>

                    <div>
                        <label class="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-1">New Password
                    ...
                    <div>
                        ...
                        <select name="role" required
                            ...
                            @foreach($roles as $role)
                                {{-- Hide superadmin option from Admin --}}
                    ...
                    <div>
                        <label class="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-1">Department <span
                                class="text-red-500">*</span></label>
                    ...
                    <div>
                        ...
                        <select name="approval_role_id"
                            ...
                            @foreach($approvalRoles as $role)
                                <option value="{{ $role->id }}" {{ old('approval_role_id', $user->approval_role_id) == $role->id ? 'selected' : '' }}>
                                    {{ $role->name }}
                                </option>
                            @endforeach
                        </select>
